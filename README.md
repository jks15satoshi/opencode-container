...
![OpenCode Tag](https://img.shields.io/github/v/tag/jks15satoshi/opencode-container?filter=opencode%2F*&logo=opencode&label=version)
![OpenChamber Tag](https://img.shields.io/github/v/tag/jks15satoshi/opencode-container?filter=openchamber%2F*&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB3aWR0aD0iMzIiIGhlaWdodD0iMzIiIHZpZXdCb3g9IjAgMCAzMiAzMiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KICA8c3R5bGU%%%%2BCiAgICA8ZyB0cmFuc2Zvcm09Im1hdHJpeCgwLjg2NiwgMC41LCAtMC44NjYsIDAuNSwgMCwgLTE1KSBzY2FsZSgwLjU1KSI%2BCiAgICAgIDxyZWN0IHg9Ii0xMiIgeT0iLTE0IiB3aWR0aD0iMjQiIGhlaWdodD0iMjgiIGZpbGw9ImN1cnJlbnRDb2xvciIgZmlsbC1vcGFjaXR5PSIwLjQiIHN0cm9rZT0iY3VycmVudENvbG9yIiBzdHJva2Utd2lkdGg9IjgiLz4KICAgIDwvZz4KICA8L2c%2BCjwvc3ZnPgo%3D&label=version)  
...
| `/secrets/ssh`                           | SSH keys directory. Used for SSH authentication in Git operations.<br/> Mount your `~/.ssh/` directory here (e.g. `-v ~/.ssh:/secrets/ssh:ro`). Keys are automatically copied to `~/.ssh/` with correct permissions at startup. |
| `/secrets/git-credentials`               | Git credentials file. Used for HTTPS authentication in Git operations.<br/> Mount your Git credentials file here (e.g. `-v ~/.git-credentials:/secrets/git-credentials:ro`). Automatically copied to `~/.git-credentials` with correct permissions at startup. |
| `/mise`                                   | Mise data directory. Stores Mise config and installed development tools. <br/> See [Managing Development Tools](#managing-development-tools).                                         |
