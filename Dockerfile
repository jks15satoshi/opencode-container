...
# Base stage
# ============================================
FROM node:26-trixie-slim@sha256:384e94c8c33ce0daae4ecbd00fa604ebabaa18f26fc508132f8da45035bf0219 AS base
...
ARG OPENCODE_SHA256=aaf91e431e00483022214d418ed83192a7c470984393bafab0c594cd1d44bcc0
...
ARG OPENCHAMBER_SHA256=39d00bf94012f8f591bfc6949d9471598af5194ad87e19aa4ae20da88123f246
RUN set -eux; \
